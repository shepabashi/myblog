...
/* WEBPACK VAR INJECTION */(function($) {(function () {
    ...
    (function () {
        ...
        var autoFitContent = function autoFitContent() {
            ...
            for (var i = 0; i < others.length; i++) {
                sumOthersHeight += $(others.get(i)).outerHeight(true);
    ...
    (function () {
        ...
        // 閉じる
        var close_panels = function close_panels() {
        ...
        var edit_category_btn_click = function edit_category_btn_click() {
